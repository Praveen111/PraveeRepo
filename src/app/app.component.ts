...
//     let indexV = this.vehicles.map(function (e) { return e.name }).indexOf(val);

//     let indexP = this.planets.map(function (e) { return e.name }).indexOf(this.planet_names[id]);
...
// this._myservice.setResult(this.result);
